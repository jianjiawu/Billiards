...
public class HitManager : MonoBehaviour {
    ...
    private void OnGUI()
    {
        if (GUI.Button(new Rect(0, 0, 100, 100), "Ball"))
        {
            if(!bUI)
            {
                UIS.m_oBall.SetActive(true);
                UIS.m_oUIClub.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f);
                UIS.m_oUIClub.transform.localPosition = new Vector3(-3000,-1000,0);
                UIS.m_oBall.transform.localScale = new Vector3(1f, 1f, 1f);
                UIS.m_oBall.transform.localPosition = new Vector3(0, 0, 0);
                UIS.m_oUIClub.SetActive(true);
                bChangeBall = true;
                bChangeClub = true;
                bUI = true;
                bCanChange = true;
            ...
            {
                UIS.m_oBall.SetActive(false);
                UIS.m_oUIClub.SetActive(false);
                bUI = false;
                bCanChange = false;
            }
        }
        if(bUI&&bCanChange)
        {
            if (GUI.Button(new Rect(100, 100, 100, 100), "B"))
            {
                UIS.m_oUIClub.transform.localScale = new Vector3(1f, 1f, 1f);
                UIS.m_oUIClub.transform.localPosition = new Vector3(0, 0, 0);
                UIS.m_oBall.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f);
                UIS.m_oBall.transform.localPosition = new Vector3(3000, -1000, 0);
                bCanChange = false;
            }
        }
        if(bUI&&!bCanChange)
        {
            if (GUI.Button(new Rect(100, 0, 100, 100), "B"))
            {
                UIS.m_oUIClub.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f);
                UIS.m_oUIClub.transform.localPosition = new Vector3(-3000, -1000, 0);
                UIS.m_oBall.transform.localScale = new Vector3(1f, 1f, 1f);
        ...
        //if (GUI.Button(new Rect(0, 100, 100, 100), "Club"))
        //{
        //    UIS.m_oClub.transform.parent.gameObject.SetActive(true);
        //    bChangeClub = true;
        //}
        //if (GUI.Button(new Rect(100, 0, 100, 100), "Ball"))
        //{
        //    UIS.m_oBall.SetActive(false);
        //    bChangeBall = false;
        //}
        //if (GUI.Button(new Rect(100, 100, 100, 100), "Club"))
        //{
        //    UIS.m_oClub.transform.parent.gameObject.SetActive(false);
        //    bChangeClub = false;
        //}
        //if (GUI.Button(new Rect(0,200,200,200),"Go"))
        //{
        //    Vector3 Force = new Vector3(0, -FroceY*10, -600);
        //    Rigidbody rb = gameObject.GetComponent<Rigidbody>();
        //    rb.AddForceAtPosition(Force, new Vector3(transform.position.x - X, transform.position.y - Y, (transform.position.z+Mathf.Sqrt(X*X+Y*Y))));
        //    //Debug.Log(new Vector3(transform.position.x + X, transform.position.y + Y, (transform.position.z + Mathf.Sqrt(X * X + Y * Y))));
        //}
    }
}
